...
import com.example.fan.its_trip.fragment.Fragment_RouteResult;

import java.util.ArrayList;
import java.util.List;

public class DNaviGuideActivity extends FragmentActivity {
                    ...
                    public void handleMessage(Message msg) {
                        switch (msg.what) {
                            ...
                            case IBNRoutePlanManager.MSG_NAVI_ROUTE_PLAN_SUCCESS:
                                ...
                                Fragment_RouteResult fragment = new Fragment_RouteResult();
